...
class MainActivity : AppCompatActivity() {
    ...
    private fun getListHeroes(): ArrayList<Video> {
        ...
        val audioResources = resources.obtainTypedArray(R.array.audio_resources)
        val listVideos = ArrayList<Video>()
        for (i in dataName.indices) {
            val video = Video(dataPhoto.getResourceId(i, -1),dataName[i], dataDescription[i], videoId.getResourceId(i,-1), audioResources.getResourceId(i, -1))
